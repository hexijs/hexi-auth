...
describe('auth', function() {
  ...
  it('should throw exception if passed auth middleware is not function', function() {
    expect(() => server.auth('not a function'))
      .to.throw(Error, 'auth middleware should be a function')
  })

  it('should throw exception if auth middleware specified more than once', function() {
  ...
  it('should run the authentication middleware before the last middleware', function(done) {
